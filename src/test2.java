...
public class test2 {
	...
	public static void main(String[] args) {
		/** a为N*N矩阵 */
		double[][] a = new double[][] { { 1, 4 / 5.0, 3, 3, 4 }, { 5 / 4.0, 1, 3, 4, 5 },
				{ 1 / 3.0, 1 / 3.0, 1, 4 / 3.0, 5 / 3.0 }, { 1 / 3.0, 1 / 4.0, 4 / 3.0, 1, 4 / 3.0 },
				{ 1 / 4.0, 1 / 5.0, 3 / 5.0, 4 / 3.0, 1 } };
		int N = a[0].length;
	...
	// 单例
	private static final test2 acw = new test2();
